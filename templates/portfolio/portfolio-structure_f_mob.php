...
// <<< The SEED Team
	...
	$qodef_portfolio_template = stockholm_qode_get_portfolio_template() . '-mobile';
// >>>
?>
<div class="container" <?php stockholm_qode_inline_page_background_style(); ?>>
	<div class="container_inner default_template_holder clearfix mobile_pr" <?php stockholm_qode_inline_page_padding_style(); ?>>
		<?php if ( ( $qodef_sidebar == "default" ) || ( $qodef_sidebar == "" ) ) : ?>
			<div class="portfolio_single space_f_mob <?php echo esc_attr( $qodef_portfolio_template ); ?>">
