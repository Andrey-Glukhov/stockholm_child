...
$j(window).load(function(){
	...
	$j('.portfolio_single_content_mob').click(function(){
		$j(this).toggle();
		$j(this).siblings('.portfolio_single_excerpt_mob').toggle();
	});
	$j('.portfolio_single_excerpt_mob').click(function(){
		$j(this).toggle();
		$j(this).siblings('.portfolio_single_content_mob').toggle();
...
function initFlexSlider(){
    ...
    $j('.flexslider').each(function(){
		...
		if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
			...
			$j('.flexslider').append('<ul class="flex-prev"></ul>');
 			$j('.flexslider .slides').addClass("flex-next");	
		};

        $j(this).flexslider({
            //animationLoop: false,
            controlNav: true,
			directionNav:!is_mobile,
			//customDirectionNav: $j(".flexslider ul"), // added
			touch: true,
            //useCSS: false,
           //pauseOnAction: true,
            //pauseOnHover: true,
